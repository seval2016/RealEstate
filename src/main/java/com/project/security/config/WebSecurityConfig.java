...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .authorizeRequests()
                .antMatchers(AUTH_WHITE_LIST).permitAll() // Swagger için izin
    ...
    private static final String[] AUTH_WHITE_LIST = {
            ...
            "/js/**",
            "/auth/login",
            "/v3/api-docs/**",  // API dökümantasyonu
            "/swagger-ui.html",  // Swagger UI ana sayfası
            "/swagger-ui/**",    // Swagger UI içindeki diğer dosyalar
            "/webjars/**"       // Swagger için gerekli olan webjars
    };
}
