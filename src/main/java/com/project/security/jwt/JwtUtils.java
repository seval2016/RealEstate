...
public class JwtUtils {
    ...
    // Secret key'i Key nesnesine dönüştürmek için kullanılacak metod
    private Key getSigningKey() {
        return Keys.secretKeyFor(SignatureAlgorithm.HS512); // Güvenli bir anahtar oluşturuldu
    }
    ...
    public String generateTokenFromUsername(String username) {
        return Jwts.builder()
                ...
                .signWith(getSigningKey()) // SignWith Key nesnesi ile güncellendi
                .compact();
    }

    public boolean validateJwtToken(String jwtToken) {
        try {
            Jwts.parserBuilder()  // parser yerine parserBuilder kullanıldı
                    .setSigningKey(getSigningKey()) // Key ile doğrulama
    ...
    public String generateResetCode(User user) {
        ...
        return Jwts.builder()
                ...
                .signWith(getSigningKey()) // SignWith Key ile güncellendi
                .compact();
    }
